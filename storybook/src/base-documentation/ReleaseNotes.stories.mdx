...
- `AutocompleteField`: enhanced to enable the addition of items to each variant using the `getCustomItem` prop, allowing for the ability to check/select newly added custom items ([#69](https://github.com/croz-ltd/tiller/issues/69))
