...
colors configuration through the `tailwind.config.js` file and components configuration through our `tillerConfig.ts` file.
...
transfer into he Playroom or the project you're working on.
