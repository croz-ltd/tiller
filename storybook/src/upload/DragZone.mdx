...
_Note that you usually do not need to provide `send` parameter. Here the mock version is used for storybook
purposes only._
...
<Canvas>
  <Story id="component-library-upload-dragzone--with-file-list" />
</Canvas>
