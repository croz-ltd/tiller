...
The `Login` component has 8 possible variants - **`Simple, Basic, With Logo, With Validation, Forgotten Password,
Email Confirmation, Reset Password and Success Password Change`**.
...
<Canvas>
  <Story id="patterns-login--with-logo" />
</Canvas>

## With Validation

<Canvas>
  <Story id="patterns-login--with-validation" />
</Canvas>

## Forgotten Password

<Canvas>
  <Story id="patterns-login--forgot-password" />
</Canvas>

## Email Confirmation

<Canvas>
  <Story id="patterns-login--email-confirmation" />
</Canvas>

## Reset Password

<Canvas>
  <Story id="patterns-login--reset-password" />
</Canvas>

## Success Password Change

<Canvas>
  <Story id="patterns-login--success-password-change" />
</Canvas>
